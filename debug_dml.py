...
from dmlUtils.helpers import seed_everything,splitData, getImgsDirs, test_dml, trainEpoch, save_checkpoint, load_checkpoint
...
miner = miners.TripletMarginMiner(margin=0.05, distance=distance, type_of_triplets="hard")
...
test_dml(ref_dataloader,validation_dataloader, model,accuracy_calculator,improveEmbedding=False,colorFeat=None)
